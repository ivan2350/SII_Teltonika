...
TIEMPO_ESPERA_CICLO = 123       # Cada cuánto se lee el tanque
        ...
        try:
            ...
            if accion is not None:
                if accion != ultimo_estado_bomba:
                    ...
                    # Log opcional de diagnóstico: estado ya correcto
                    log(f"Bomba ya en estado correcto → {'ENCENDIDA' if accion else 'APAGADA'}")
